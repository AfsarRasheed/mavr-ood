    ...
    try:
        ...
        return JSONResponse({
            ...
            "parsed": {
                ...
                "grounding_backend": results.get('grounding_backend', 'florence2'),
            },
...
async def ood_detect(
    ...
    try:
        ...
        return JSONResponse({
            ...
            "prompt_v2": prompt_v2,
            "original_image": img_to_b64(img_np),
            "reasoning": agent_results.get("agent5", {}).get("reasoning", ""),
            "anomaly_type": agent_results.get("agent5", {}).get("anomaly_type", ""),
